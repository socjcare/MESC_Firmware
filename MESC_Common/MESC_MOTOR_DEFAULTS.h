...
#if defined(MYMOTOR) //Reliable params
#define MAX_MOTOR_PHASE_CURRENT 40.0f
#define DEFAULT_MOTOR_POWER 500.0f
#define DEFAULT_FLUX_LINKAGE 0.001f//Set this to the motor linkage in wB
#define DEFAULT_MOTOR_Ld 0.000010f //Henries
#define DEFAULT_MOTOR_Lq 0.000010f//Henries
#define DEFAULT_MOTOR_R 0.030 //Ohms
#define DEFAULT_MOTOR_PP 7 //Pole Pairs


#elif defined(SEGWAY) //Reliable params -SC
#define MAX_MOTOR_PHASE_CURRENT 40.0f
#define DEFAULT_MOTOR_POWER 1000.0f
#define DEFAULT_FLUX_LINKAGE 0.02f//Set this to the motor linkage in wB
#define DEFAULT_MOTOR_Ld 0.000040f //Henries
#define DEFAULT_MOTOR_Lq 0.000040f//Henries
#define DEFAULT_MOTOR_R 0.30 //Ohms
#define DEFAULT_MOTOR_PP 15 //Pole Pairs
...
#define DEFAULT_MOTOR_Ld 0.000010f //Henries
#define DEFAULT_MOTOR_Lq 0.000010f//Henries
#define DEFAULT_MOTOR_R 0.0f //Ohms
